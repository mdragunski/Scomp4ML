##################################################################################################################
#
#                                       Scomp4ML - CONTROL SCIPT
#   Author: Marc Dragunski
#   Date: 9th April, 2019
#
#   This is the main control script contains for my Masters Thesis. It includes...
#   
##################################################################################################################
rm(list=ls())
##################################################################################################################
...
#                                    General adjustments
##################################################################################################################
#choose where to work (currently only "marc" is supported. 
